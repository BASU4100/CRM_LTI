...
export class HttpService {
  ...
  updateBookingStatus(bookingId: any, status: string): Observable<any> {
    return this.http.put<any>(`${this.serverName}/api/agent/bookings/${bookingId}/status?status=${status}`, {}, { headers: this.getHeaders() });
  }
